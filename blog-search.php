...
?>
		...
		<section class="row">
			<div class="col-sm-8">
				<h2 class="header-date-name"></h2>
				<?php 
					$news = getBlogNewsForSearch($s);
					if($news != ''){
						echo '<p class="some-news">Posty z frazą: '.$s.'</p>';
						echo $news;
					}else{
						echo '<p class="no-news">Niestety nie ma postów z frazą:<br> '.$s.'</p>';
					}
				?>
